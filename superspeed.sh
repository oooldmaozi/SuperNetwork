...
preinfo() {
	...
	echo "       bash <(curl -Lso- https://github.com/oooldmaozi/SuperNetwork/blob/master/superspeed.sh)"
	echo "       全部节点列表:  https://github.com/oooldmaozi/SuperNetwork/blob/master/ServerList.md"
